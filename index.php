    ...
    <section class="benefits">
        <div class="container">
            <div class="benefits__inner">
                <img src="images/car.png" alt="" class="benefits__images">
            ...
            <div class="carousel__inner">
                <div class="carousel__item">
                    <div class="carousel__item-box">
                        <img src="images/carousel/1.jpg" alt="1" class="carousel__item-img">
                ...
                <div class="carousel__item">
                    <div class="carousel__item-box">
                        <img src="images/carousel/2.jpg" alt="1" class="carousel__item-img">
                ...
                <div class="carousel__item">
                    <div class="carousel__item-box">
                        <img src="images/carousel/3.jpg" alt="1" class="carousel__item-img">
                        <h4 class="carousel__item-title"> TESLA MODEL 3 2018 г.</h4>
                        <p class="carousel__item-text">Экономия 5500 $</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="contacts__inner">
                ...
                <form class="contacts__form">
                    ...
                    <input type="text" placeholder="Как Вас зовут" class="contacts__input">
                    <input type="text" placeholder="Ваш номер телефона" class="contacts__input"> 
